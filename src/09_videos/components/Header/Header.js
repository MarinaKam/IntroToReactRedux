...
const Header = () => (
    <Fragment>
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <Link className="navbar-brand" to="/IntroToReactRedux/">Films4U</Link>
            ...
            <div className="collapse navbar-collapse" id="navbarNavDropdown">
                <ul className="navbar-nav">
                    <li className='nav-item'>
                        <NavLink exact={true} className='nav-link' activeClassName='active' to="/IntroToReactRedux/">
                    ...
                    <li className='nav-item'>
                        <NavLink exact={true} className='nav-link' activeClassName='active' to="/IntroToReactRedux/popular">
                    ...
                    <li className='nav-item'>
                        <NavLink  exact={true} className='nav-link' activeClassName='active' to="/IntroToReactRedux/top-rated">
                    ...
                    <li className='nav-item'>
                        <NavLink exact={true} className='nav-link' activeClassName='active' to="/IntroToReactRedux/coming-soon">Coming Soon</NavLink>
                    </li>
                </ul>
            </div>
        </nav>
